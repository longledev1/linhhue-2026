...
export default function LandInfoSidebar({ specs }) {
  return (
    <>
      {/* ================= LAYOUT 1: HIỂN THỊ TRÊN MOBILE (DẠNG GRID) ================= */}
          ...
          {specs.map((item, idx) => {
            ...
            return (
              <div
                ...
                style={{
                  // 🌟 FIX LƯỚI MOBILE: Đất nền có 6 phần tử đầu chia làm 2 hàng (0,1,2 và 3,4,5).
                  // Ẩn đường viền phải ở cuối mỗi hàng (vị trí index 2 và 5) để giao diện sạch sẽ.
                  borderRightColor:
              ...
              >
                ...
                >
                  ...
                  >
                    {/* Giữ logic render giá trị linh hoạt */}
