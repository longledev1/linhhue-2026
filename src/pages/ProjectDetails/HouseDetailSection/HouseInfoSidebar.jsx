...
export default function InfoSidebar({ specs, phone_number }) {
  ...
  // TRÍCH XUẤT CÁC TRƯỜNG THÔNG SỐ NGẮN
        ...
        {longSpecs.length > 0 && (
          <div className="w-full space-y-3.5">
            {longSpecs.map((item, idx) => (
              ...
              >
                {/* Nhãn nằm độc lập hàng trên, tạo điểm tựa thị giác */}
                <span className="text-[11px] font-bold tracking-wider text-stone-400 uppercase">
                  {formatLabelText(item.label)}
                </span>
                {/* Nội dung chiếm trọn 100% không gian hàng dưới, hiển thị chuẩn văn bản đa dòng */}
